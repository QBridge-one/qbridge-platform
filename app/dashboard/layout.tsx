      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-16 shrink-0 items-center gap-4 border-b bg-card px-6">
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            {/* Wallet avatar */}
            <button className="flex h-9 w-9 items-center justify-center rounded-full bg-primary text-primary-foreground text-xs font-bold hover:opacity-90 transition-opacity">
              AC
            </button>
          </div>
        </header>
