      ...
      {filtered.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed py-16 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            ...
            <Link href="/dashboard/assets/new" className="text-primary underline-offset-4 hover:underline">
              create a new asset
            </Link>
          </p>
        </div>
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem asChild>
                  <Link href={`/dashboard/tokens?asset=${asset.id}`}>Token Ops</Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href={`/dashboard/cap-table?asset=${asset.id}`}>Cap Table</Link>
                </DropdownMenuItem>
                {isLive && (
                  <>
                    <DropdownMenuSeparator />
